...
static unsigned int sqlctx = 38587;
...
{13,4130,1,0,0,
5,0,0,0,0,0,27,62,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,46,0,3,81,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
67,0,0,3,0,0,30,85,0,0,0,0,0,1,0,
82,0,0,0,0,0,27,116,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
113,0,0,5,38,0,2,133,0,0,1,1,0,1,0,1,9,0,0,
132,0,0,6,0,0,30,137,0,0,0,0,0,1,0,
147,0,0,7,0,0,32,155,0,0,0,0,0,1,0,
};
...
int main() {
	...
	for( i = 1; i < 100; i++)
	{
		...
		char  chCardNum[20] = "11223344556677889900";
...
struct { unsigned short len; unsigned char arr[20]; } pass;
		...
		/* VARCHAR     vchPhone[11]; */ 
struct { unsigned short len; unsigned char arr[11]; } vchPhone;

		/* VARCHAR     vchName[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } vchName;
 
		/* VARCHAR     vchCardNum[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } vchCardNum;
 
		/* VARCHAR     vchCardInc[20]; */ 
struct { unsigned short len; unsigned char arr[20]; } vchCardInc;
...
// using :tnsname;
	...
	/* EXEC SQL INSERT INTO CUSTOMER VALUES( :vchPhone, :vchName, :vchCardNum, :vchCardInc); */ 

{
 ...
 sqlstm.sqlety = (unsigned short)4352;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (unsigned char  *)&vchPhone;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (unsigned char  *)&vchName;
 sqlstm.sqhstl[1] = (unsigned long )22;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (unsigned char  *)&vchCardNum;
 ...
 sqlstm.sqhstv[3] = (unsigned char  *)&vchCardInc;
 ...
 if (sqlca.sqlcode < 0) goto error_msg;
	...
	printf("INSERT INTO CUSTOMER VALUES /(%s %s %s %s /)\n", chPhone, chName, chCardNum, chCardInc);
...
struct { unsigned short len; unsigned char arr[20]; } pass;
		...
		/* VARCHAR     vchPhone[12]; */ 
struct { unsigned short len; unsigned char arr[12]; } vchPhone;
...
// using :tnsname;
	...
	// Declare the cursor. All static SQL explicit cursors 
	/* EXEC SQL DELETE FROM CUSTOMER WHERE PHONE = :vchPhone; */ 

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "delete  from CUSTOMER  where PHONE=:b0";
 sqlstm.iters = (unsigned int  )1;
 ...
 if (sqlca.sqlcode < 0) goto error_msg;
	...
	printf("DELETE FROM CUSTOMER WHERE PHONE = %s\n", chPhone);
