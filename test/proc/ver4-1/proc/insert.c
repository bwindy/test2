...
{13,4130,1,0,0,
5,0,0,0,0,0,27,65,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,44,0,3,84,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
67,0,0,3,0,0,30,88,0,0,0,0,0,1,0,
82,0,0,0,0,0,27,118,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
113,0,0,5,36,0,2,135,0,0,1,1,0,1,0,1,9,0,0,
132,0,0,6,0,0,30,139,0,0,0,0,0,1,0,
147,0,0,7,0,0,32,158,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[21]; } vchCardNum;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into CUSTOM  values (:b0,:b1,:b2,:b3)";
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "delete  from CUSTOM  where PHONE=:b0";
 sqlstm.iters = (unsigned int  )1;
