...
//    char substr[500] = "-pcm=../data/wakeup.pcm  -model=../model/wakeup_ja.fuet -record";
    ...
    memset( firstFNpcm, 0x00, sizeof(firstFNpcm) );
    memset( firstFNwav, 0x00, sizeof(firstFNwav) );
    memset( secondFNpcm, 0x00, sizeof(secondFNpcm) );
    memset( secondFNwav, 0x00, sizeof(secondFNwav) );
